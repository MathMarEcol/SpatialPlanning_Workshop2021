...
proj4string(tas_pu) <- albers # There is a problem with projectio so we re-add it here
proj4string(tas_features) <- albers # There is a problem with projectio so we re-add it here
